...
// use reduce to sum the ID's of all games
...
const unfundedStatement = `A total of $${totalPledged.toLocaleString()} has been raised across ${totalGames} ${totalGames === 1 ? 'game' : 'games'}. Currently, ${numUnfunded} ${numUnfunded === 1 ? 'game is' : 'games are'} still seeking funding.`;


// create a new DOM element containing the template string and append it to the description container
const companyInfo = document.createElement('p');
companyInfo.textContent = unfundedStatement;
...
const [topFunded, runnerUp, ...rest] = sortedGames;

// create a new element to hold the name of the top pledge game, then append it to the correct element
const topGameName = document.createElement('p');
topGameName.textContent = topFunded.name;
